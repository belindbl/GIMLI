#this file is for separate lidar data on our pitch scenario, add timing. 
...
if __name__ == "__main__":
    ...
    while True:
        ...
        timestamp = f"{current_time:.3f}"  # Format to 3 decimal places
        #filename = get_sensordata_path(f'/pcl/pcl_{timestamp}_frame{imageNum}.pcd')
        filename = get_sensordata_path(f'/pcl/{timestamp}.pcd')
