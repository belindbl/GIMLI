...
def camera_thread():
    ...
    camera_client = ALSLib.TCPClient.TCPClient(camera_host, camera_port, 2)
    ...
    while not stop_threads_event.is_set():
        ...
        time.sleep(0.02)  # Reduced sleep time for better frame rate
    ...
    while not stop_threads_event.is_set():
        try:
            ...
            if lidar_data:
                ...
                # Extract XYZ points
                points = point_array[:, :3]  # First 3 columns are x, y, z
